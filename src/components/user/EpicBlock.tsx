...
const EpicBlock: React.FC<EpicBlockProps> = ({ epicId, title, taskCount, onSelect, selectedEpics, handleSelectedEpic, taskDetails }) => {
  ...
  console.log("epic details.......................taskDetails", taskDetails)
  ...
  return (
    <div className={`flex flex-col gap-3  text-white p-3 rounded-md hover:bg-[#2a2a2a] transition-colors cursor-pointer ${selectedEpics ? "bg-[#2a2a2a]" : "bg-[#1a1a1a]"}`} onClick={onSelect}>
      ...
      {/* Status bar here i need to show the progress of the epics*/}
      <div className="w-full bg-[#323232] rounded-full h-1">
        <div
          className="bg-green-500 h-1 rounded-full"
          style={{ width: `${taskDetails.progress.total}%` }}
        ></div>
      </div>
