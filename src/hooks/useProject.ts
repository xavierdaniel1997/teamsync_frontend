...
import {
  ...
  deleteTaskApi,
  getAllProjectsApi,
  getAllTaskByProjectsApi,
  getBacklogTasksApi,
  getEpicsByProjectApi,
  getKanbanTaskApi,
  getProjectByIdApi,
  getSprintApi,
  getTaskFromSprintApi,
  inviteMemeberToProjectApi,
  startSprintApi,
  updateKanbanTaskApi,
  updateProjectApi,
  updateTaskApi,
...
export const useProject = () => {
  ...
  const useInviteMember = useMutation({
    mutationFn: ({
      ...
      workspaceId: string;
      emails: string[];
    }) => inviteMemeberToProjectApi(projectId, workspaceId, emails),
    onSuccess: (response) => {
    ...
    onError: (error: any) => {
      ...
      toast.error(
        error?.response?.data?.message ||
          "Failed to invite team member to the project"
      );
    },
  });
  ...
  const useDeleteProject = useMutation({
    mutationFn: ({
      ...
      projectId: string;
      workspaceId: string;
    }) => deleteProjectApi(projectId, workspaceId),
    onSuccess: (response) => {
  ...
  const useGetTasksByProject = (
    ...
    return useQuery<TaskResponse>({
      ...
      queryFn: () =>
        getAllTaskByProjectsApi(workspaceId, projectId, assignees, epics),
  ...
  const useGetKanbanTasks = (
    ...
    return useQuery<TaskResponse>({
      queryKey: ["kanbanTasks", workspaceId, projectId, assignees, epics],
  ...
  const useDeleteSprint = useMutation({
    mutationFn: ({
      ...
      projectId: string;
      sprintId: string;
    }) => deleteSprintApi(workspaceId, projectId, sprintId),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["sprints"] });
      queryClient.invalidateQueries({ queryKey: ["task"] });
  ...
  const useStartSprint = useMutation({
    mutationFn: ({
      ...
      sprintId: string;
      data: IStartSprint;
    }) => startSprintApi(workspaceId, projectId, sprintId, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["sprints"] });
